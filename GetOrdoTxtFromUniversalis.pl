...
=pod
=head1 Package: GetOrdoFromUniversalis.pl
...
my $usage = "Usage: $0 -r NOE|VOE -y YYYY [-o OutputFilePath (default:STDOUT)]\n";
...
if ($response->is_success) {
    ...
    $logger->fatal("HTTP GET failed for URL $url");
